        ...
        if STATE == 0:
            while STATE==0:
                ...
                if ret == True:
                    ...
                    mask = cv2.fillPoly(white_res, np.array([[(0,0),(0,647),(350,647),(350,0)]],dtype=np.int32), 0)
                    mask = cv2.fillPoly(mask, np.array([[(802,0),(802,647),(1152,647),(1152,0)]],dtype=np.int32), 0)
